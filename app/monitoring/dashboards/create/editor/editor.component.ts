...
@Component({
  selector: 'covalent-create-dashboard-editor',
...
export class DashboardEditorComponent implements OnInit {
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(DashboardEditorDialogComponent, {
      width: '75%',
      data: { title: this.title, subtitle: this.subtitle, showChart: this.showChart }
    });

    dialogRef.afterClosed().subscribe(result => {
      console.log('The dialog was closed');
      this.title = "CPU Utilization";
      this.subtitle = "Processor utilization by hour";
      this.showChart = true;
    });
  }
}
...
@Component({
  selector: 'covalent-create-dashboard-dialog',
  templateUrl: 'editor-dialog.component.html',
})
export class DashboardEditorDialogComponent {

  constructor(
    public dialogRef: MatDialogRef<DashboardEditorDialogComponent>,
